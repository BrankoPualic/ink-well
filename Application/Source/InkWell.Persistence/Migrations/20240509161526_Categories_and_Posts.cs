...
{
	/// <inheritdoc />
	public partial class Categories_and_Posts : Migration
	{
		/// <inheritdoc />
		...
		protected override void Down(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.UpdateData(
				...
				keyValue: new Guid("00000000-0000-0000-0000-000000000001"),
				columns: new[] { "CreatedAt", "Password" },
				values: new object[] { new DateTime(2024, 5, 9, 12, 41, 7, 43, DateTimeKind.Utc).AddTicks(2639), "$2a$11$VuXJEJUd9b2qsT4KOL5VdOSHSUAuPucpJI/1mFX1QucoT3eEBVcJi" });
		}
	}
}