...
namespace InkWell.Persistence.Migrations
{
    ...
    [Migration("20240528204525_FixedAuditColumnName")]
    partial class FixedAuditColumnName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InkWell.Domain.Entities.Application.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 64, DateTimeKind.Utc).AddTicks(5526),
                            IsActive = true,
                            Name = "Travel"
                        },
                        new
                        {
                            Id = new Guid("5614c3f1-e721-4489-9a59-e89765ae3acc"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 64, DateTimeKind.Utc).AddTicks(5558),
                            IsActive = true,
                            Name = "Sport"
                        },
                        new
                        {
                            Id = new Guid("3847df5a-d1f5-4885-aa11-635e8be8a463"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 64, DateTimeKind.Utc).AddTicks(5575),
                            IsActive = true,
                            Name = "Basketball",
                            ParentId = new Guid("5614c3f1-e721-4489-9a59-e89765ae3acc")
                        },
                        new
                        {
                            Id = new Guid("cd7d05ca-ab09-42a4-9a12-0a59166b58e7"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 64, DateTimeKind.Utc).AddTicks(5578),
                            IsActive = true,
                            Name = "Football",
                            ParentId = new Guid("5614c3f1-e721-4489-9a59-e89765ae3acc")
                        },
                        new
                        {
                            Id = new Guid("6a0da462-402c-4556-a533-7720abb40bf8"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 64, DateTimeKind.Utc).AddTicks(5580),
                            IsActive = true,
                            Name = "NBA",
                            ParentId = new Guid("3847df5a-d1f5-4885-aa11-635e8be8a463")
                        },
                        new
                        {
                            Id = new Guid("c43a355f-7c4a-4451-a600-b20b2ace4267"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 64, DateTimeKind.Utc).AddTicks(5582),
                            IsActive = true,
                            Name = "Euroleague",
                            ParentId = new Guid("3847df5a-d1f5-4885-aa11-635e8be8a463")
                        });
            ...
            modelBuilder.Entity("InkWell.Domain.Entities.Application.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1fdd5985-dc49-45cf-8f7b-df814435a7d6"),
                            AuthorId = new Guid("00000000-0000-0000-0000-000000000001"),
                            CategoryId = new Guid("00000000-0000-0000-0000-123345123411"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 69, DateTimeKind.Utc).AddTicks(4969),
                        ...
                        new
                        {
                            Id = new Guid("ef8af730-d9c4-41a3-a0bd-c94cd7caaa50"),
                            AuthorId = new Guid("00000000-0000-0000-0000-000000000001"),
                            CategoryId = new Guid("00000000-0000-0000-0000-123345123411"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 69, DateTimeKind.Utc).AddTicks(4974),
            ...
            modelBuilder.Entity("InkWell.Domain.Entities.Application.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 175, DateTimeKind.Utc).AddTicks(9894),
                            ...
                            Password = "$2a$11$U4TMSkgVG00HgaewjDbJOuXUbQV7M305lxKSxIp3Sd.Yp3gtkXFsq",
                            Username = "system-admin1"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 282, DateTimeKind.Utc).AddTicks(2102),
                            DateOfBirth = new DateOnly(2002, 10, 10),
                            ...
                            IsActive = false,
                            LastName = "Pualic-Radujko",
                            Password = "$2a$11$BAc4VgU0tx.k90w.sdGESeLsxk0PUeQNbyz.Ywlj.h3FeRYPJkKyC",
                            Username = "system-useradmin1"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 388, DateTimeKind.Utc).AddTicks(5298),
                            DateOfBirth = new DateOnly(2002, 10, 10),
                            ...
                            IsActive = false,
                            LastName = "Pualic-Radujko",
                            Password = "$2a$11$bszNE9vfyrHNU1bkGNxgleT5rlHChgCO4W5k6Bb/6uhvloDn4LX.S",
                            Username = "system-moderator1"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000004"),
                            CreatedAt = new DateTime(2024, 5, 28, 20, 45, 24, 494, DateTimeKind.Utc).AddTicks(4554),
                            DateOfBirth = new DateOnly(2002, 10, 10),
                            ...
                            IsActive = false,
                            LastName = "Pualic-Radujko",
                            Password = "$2a$11$6jc7Lxk4hjAxTpjyZco3QewxKgJP4m4h5xfbllXyPN4lniy1RJvw2",
